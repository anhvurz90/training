...
public class EventProducer extends GenericPortlet {
  ...
  protected void doView(RenderRequest renderRequest, RenderResponse renderResponse)
    ...
    PortletRequestDispatcher rd = context.getRequestDispatcher("/jsp/ipc/Producer.jsp");
  ...
  public void processAction(ActionRequest actionRequest, ActionResponse actionResponse)
      throws PortletException, IOException {
    String content = actionRequest.getParameter("evt");
    SampleEvent event = new SampleEvent();
    event.setContent(content);
    actionResponse.setEvent("SampleEvent", event);
