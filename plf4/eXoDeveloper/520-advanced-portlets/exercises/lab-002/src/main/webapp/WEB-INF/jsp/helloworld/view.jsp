...
// Get the link to the EDIT mode (note that could be done with Taglib)
...
<p>
You can <a href="<%=editURL%>"><u>edit</u></a> the portlet to change it. You can also use the <a href="<%=helpURL%>"><u>help</u></a>.
</p>
</blockquote>
